...
// 应用配置
export { enhancedAppRegistry, getAllApps, getSystemApps, getDemoApps, getUserApps, getAppByKey, getAppsByCategory, getDesktopApps, getDockApps, getFeaturedApps, searchApps, validateAppConfig, registerApp, unregisterApp, updateAppConfig, appRegistry } from '../core/app-registry'
export { appDefaults } from '../core/app-registry/app-defaults'

// 主题配置
export * from '../features/themes/theme.config'
export { lightTheme, darkTheme, themes, defaultTheme, generateCSSVariables, applyTheme, getSystemTheme, themeUtils } from '../features/themes/theme.config'
