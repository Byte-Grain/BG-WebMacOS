...
<script setup>
  ...
  import bgImageUrl from '@/assets/images/bg.jpg'
  import LanguageSwitcher from '@shared/components/business/LanguageSwitcher.vue'
  import { useUtils } from '@shared/composables'
